...
export const latestRelease = {
  ...
  checksum:
    'https://github.com/wzz6423/zisla/releases/download/release/v0.1.6/zisla-v0.1.6-macOS-arm64.zip.sha256',
  universalDmg:
    'https://github.com/wzz6423/zisla/releases/download/release/v0.1.6/zisla-v0.1.6-macOS-universal.dmg',
  universalZip:
    'https://github.com/wzz6423/zisla/releases/download/release/v0.1.6/zisla-v0.1.6-macOS-universal.zip',
  intelDmg:
    'https://github.com/wzz6423/zisla/releases/download/release/v0.1.6/zisla-v0.1.6-macOS-x86_64.dmg',
  intelZip:
    'https://github.com/wzz6423/zisla/releases/download/release/v0.1.6/zisla-v0.1.6-macOS-x86_64.zip',
