...
// Adapted for Zisla from Mac Duo's Apache-2.0 `DepthShaders`.
// The shader is compiled from source at launch, so the file needs no `.metal`
// build step and no resource in the bundle.
