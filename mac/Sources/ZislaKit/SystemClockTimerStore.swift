...
enum SystemClockTimerStore {
    ...
    private static func timer(from value: Any) -> SystemClockTimerSnapshot? {
        guard let wrapper = value as? [String: Any],
              ...
              let fireTime = timer["MTTimerFireTime"] as? [String: Any] else {
            return nil
        }
        ...
        case 3:
            guard let absolute = fireTime["$MTTimerDate"] as? [String: Any],
        ...
        default:
            // Stopped presets use the same interval payload as paused timers.
            return nil
        }
