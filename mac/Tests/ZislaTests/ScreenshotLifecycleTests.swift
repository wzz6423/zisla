...
struct ScreenshotLifecycleTests {
    ...
    func screenshotCaptureUsesTheMacOS26ConfigurationAndKeepsAnOlderFallback() throws {
        ...
        #expect(source.contains("configuration.ignoreShadows = false"))
        #expect(source.contains("configuration.ignoreClipping = false"))
        #expect(source.contains("configuration.includeChildWindows = true"))
        #expect(source.contains("configuration.ignoreShadowsDisplay = false"))
        #expect(source.contains("configuration.ignoreGlobalClipDisplay = false"))
        #expect(source.contains("if #available(macOS 14.2, *) {\n            configuration.includeChildWindows = true\n        }"))
