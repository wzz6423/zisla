...
public:
    ...
    void requestOverlayRelayout() noexcept;
    void promoteOverlay();
    void dismissOverlay();
    void togglePin();
    void showSettings();
    ...
    void setTaskbarWidgetPosition(zisla::core::TaskbarWidgetPosition position);
    ...
    [[nodiscard]] zisla::core::TaskbarWidgetPosition taskbarWidgetPosition() const noexcept;
    ...
    [[nodiscard]] std::string applicationVersion() const;
...
private:
    ...
    static constexpr UINT taskbar_exit_message = WM_APP + 30;
    ...
    [[nodiscard]] std::optional<zisla::core::PixelRect> overlayBounds(
    ...
    zisla::core::TaskbarWidgetPosition taskbar_widget_position_{
    ...
    std::shared_ptr<const zisla::core::NowPlayingSnapshot> now_playing_snapshot_;
    ...
    zisla::core::SideNoticeQueue tray_notice_queue_;
    ...
    std::unique_ptr<TaskbarButtonWindow> taskbar_button_window_;
    ...
    std::unique_ptr<SideNoticeWindow> tray_notice_window_;
