...
public:
    ...
    explicit GrokActivityMonitor(std::filesystem::path sessions_directory);
    ~GrokActivityMonitor();

    GrokActivityMonitor(const GrokActivityMonitor&) = delete;
    GrokActivityMonitor& operator=(const GrokActivityMonitor&) = delete;
    ...
    [[nodiscard]] static std::optional<std::filesystem::path>
        defaultSessionsDirectory() noexcept;
