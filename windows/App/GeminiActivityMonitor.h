...
public:
    ...
    explicit GeminiActivityMonitor(std::filesystem::path sessions_root);
    ~GeminiActivityMonitor();

    GeminiActivityMonitor(const GeminiActivityMonitor&) = delete;
    GeminiActivityMonitor& operator=(const GeminiActivityMonitor&) = delete;
