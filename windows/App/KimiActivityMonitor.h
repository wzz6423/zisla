...
public:
    ...
    explicit KimiActivityMonitor(std::filesystem::path home_directory);
    ~KimiActivityMonitor();

    KimiActivityMonitor(const KimiActivityMonitor&) = delete;
    KimiActivityMonitor& operator=(const KimiActivityMonitor&) = delete;
